...
#    filled_ptrn.append(filled_ptrn[0])
    ...
    x, r, data, cst = model.predict_pose(opt_ptrn, init_pose, stats=1,
                                         debug=0, f=f)
...
def test():
    ...
    opt_ptrn = [[[90, 0.1, -90, 0.1, 90], [1, 0, 0, 1]],
                [[90, 90, -90, 0.1, 90], [1, 0, 0, 1]],
                [[90, 0.1, -90, 0.1, 90], [1, 0, 0, 1]]]
    repr_gait(opt_ptrn, f, 'test')
